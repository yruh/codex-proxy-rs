...
pub fn openai_billing_breakdown_with_override(
    ...
    openai_billing_breakdown_with_override_and_policy(model, usage, service_tier, pricing, false)
}

pub(crate) fn openai_billing_breakdown_with_override_and_policy(
    model: &str,
    usage: OpenAiBillingUsage,
    service_tier: Option<&str>,
    pricing: Option<&gateway_core::metering::ModelPriceOverride>,

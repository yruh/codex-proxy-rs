...
export interface PortalWallet extends WalletPolicy { userId: string, balanceUsd: string, totalSpentUsd: string, dailyUsedUsd: string, weeklyUsedUsd: string, weeklyResetsAt: string, activeRequests: number }
